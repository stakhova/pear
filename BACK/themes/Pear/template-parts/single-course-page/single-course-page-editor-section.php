...
class Single_Course_Page_Editor_Section
{
    public function __construct()
    {
        ...
        $this->place = $section_content['place'];
        $this->map_link = $section_content['map_link'];
        $this->map = $section_content['map'];
        $this->content = $section_content['content'];
        $this->certificate = $section_content['certificate'];
        $this->speaker_image = $section_content['speaker_image'];
        $this->speaker_title = $section_content['speaker_title'];
        $this->speaker_text = $section_content['speaker_text'];
    }
